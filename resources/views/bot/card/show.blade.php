                ...
                <div class="flex flex-col items-start space-y-2">
                  ...
                  @foreach ($card->stamps as $stamp)
                      <div class="flex flex-row space-x-2">
                        ...
                        <div class="flex items-center text-gray-200 font-normal">{{$stamp->title}}</div>
                      </div>
                  @endforeach 
                </div>   
              </div>
                ...
                <div class="flex flex-col w-full">
                  ...
                  <div class="flex flex-row items-between space-x-4">
                    <div class="flex lg:flex-row flex-col justify-between bg-zinc-500 rounded-md lg:w-11/12 w-4/5 p-4 mt-2">
                      <div class="text-white text-2xl">Промокод: {{$promocode->title}}</div>
                      <div class="flex items-center text-white">Действует до: {{$promocode->expiration_date}}</div>
                    </div>
