@extends('layouts.bot')
@section('title', 'Промокоды в категории ' . $category->title . ' за ' . $titleDate . ' | MOBUX')
@section('content')
<h1 class="text-white px-6 text-2xl font-semibold">{{$category->title}}:</h1>
<p class="text-gray-100 text-sm px-6 py-2">Магазинов: {{$cardsCount}}</p>
